...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `dojo_and_ninjas_schema` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dojo_and_ninjas_schema`.`dojos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dojo_and_ninjas_schema`.`ninjas` ;
...
CREATE TABLE IF NOT EXISTS `dojo_and_ninjas_schema`.`ninjas` (
  ...
  CONSTRAINT `fk_ninjas_dojos`
    ...
    REFERENCES `dojo_and_ninjas_schema`.`dojos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
